...
namespace inventory
{
    public partial class ACCOUNT : Form
    {
        ...
        public void loadData()
        {
            ...
            try
            {
                String query = "SELECT Firstname,Lastname,Username,Email from tbl_adminlogin";
        ...
        public void Add(String Firstname, String Middlename, String Lastname, String Username, String Password, String Email)
        {
            ...
            try
            {
                ...
                conn1.Open();
                string query = "INSERT INTO tbl_adminlogin (Firstname, Middlename, Lastname, Username, Password,Email) VALUES ('" + Firstname + "','" + Middlename + "','" + Lastname + "','" + Username + "','" + Password + "','" + Email + "')";
        ...
        public void delete(string delete2)
        {
            ...
            try
            {
                ...
                conn1.Open();
                string query = "DELETE FROM tbl_adminlogin WHERE id= '" + delete2 + "';"; ;
                MySqlCommand cmd = new MySqlCommand(query, conn1);
                int check = cmd.ExecuteNonQuery();
                if (check > 0)
                {
        ...
        public void CheckingIfExist(String Firstname, String Middlename,String Lastname)
        {
            ...
            try
            {
                ...
                string query1 = "select count(*)  from tbl_adminlogin where Firstname='" + Firstname + "' AND Middlename = '" + Middlename + "' AND Lastname = '" + Lastname + "'";
